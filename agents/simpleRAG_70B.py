...
class DirectAgent:
    ...
    def _build_agent_prompt(self) -> str:
        ...
        return self.agent_prompt.format(
            ...
            # news_articles = self.query_info['NewsArticles'],
...
if __name__ == "__main__":
    ...
    if "extract_rectify" in args.alias:
        from agent_prompts.prompt_extraction_simpleRAG_rectify import extraction_prompt
    elif "extract_generate" in args.alias:
        from agent_prompts.prompt_extraction_simpleRAG_default import extraction_prompt
    else:
        print("No explition. Default extraction prompt")
        from agent_prompts.prompt_extraction_simpleRAG_default import extraction_prompt
    ...
    eval_dir = os.path.join("../output_eval/simplerag_noguide/", args.dataset)
