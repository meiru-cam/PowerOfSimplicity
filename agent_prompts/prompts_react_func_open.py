# Unified prompt file for all open react_func plans (without scratchpad)
# This file replaces prompts_react_func_partial_open.py and prompts_react_func_partial_rel.py
