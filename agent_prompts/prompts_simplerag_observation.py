...
Here is the information that has been collected for you to make the forecast. The functions used to collect the information and their corresponding results are as follows:
{information}
