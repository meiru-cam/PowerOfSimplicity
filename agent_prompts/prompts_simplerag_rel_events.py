# Unified prompt file for rel_e_bi, rel_e_uni, and rel plans
# This file replaces prompts_simplerag_rel_e_bi.py, prompts_simplerag_rel_e_uni.py, and prompts_simplerag_rel.py
...
Here is the frequency of relation between {actor1_name} and {actor2_name} up to {current_date_nlp}:
...
relation_prompt = PromptTemplate(
    input_variables=["actor1_name", "actor2_name", "future_date_nlp", "current_date_nlp", "future_date", "actor1_code", "actor2_code", "events", "cameo_description", "relation_distribution"],
