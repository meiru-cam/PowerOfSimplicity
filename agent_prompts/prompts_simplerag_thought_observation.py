...
Here is the information that has been collected for you to make the forecast. The reasoning behind collecting this information and the corresponding results are as follows:
{information}
