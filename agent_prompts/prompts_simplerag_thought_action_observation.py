...
Here is the information that has been collected for you to make the forecast. The reasoning behind collecting this information, the functions used to collect it, and the corresponding results are as follows:
{information}
...
relation_prompt = PromptTemplate(
    input_variables=["actor1_name", "actor2_name", "future_date_nlp", "current_date_nlp", "future_date", "actor1_code", "actor2_code", "information"],
