...
class Event:
    ...
    tail_entity: ISOCode
    title: str
    # Example: Event(date=Date("2023-01-01"), head_entity=ISOCode("USA"), relation=CAMEOCode("010"), tail_entity=ISOCode("CAN"), title="USA president makes a statement to Canada")
